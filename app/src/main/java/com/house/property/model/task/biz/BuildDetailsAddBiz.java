...
public class BuildDetailsAddBiz extends BaseBiz {
    /**
     *新增楼栋详细信息
     */
    private final String API_LOGIN = "build/addBuildDetails";
    public void addBuildDetails(BuildDetailsVO bean, LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
        ...
        request.put("pdSList",bean.getPdSList());
        request.put("attributeLits",bean.getAttributeLits());
        request.put("gisObjVO",bean.getGisObjVO());
        ...
        callback.setParseHelper(new ParseHelper() {
            ...
            public Object[] parse(JsonElement jsonElement) {
                GisObjVO bean = new Gson().fromJson(jsonElement, GisObjVO.class);
