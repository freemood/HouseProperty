...
public class CommDetailsAddBiz extends BaseBiz {
    /**
     *新增小区详细信息
     */
    private final String API_LOGIN = "community/addCommunityDetails";
    public void addCommunityDetails(CommunityDetailsBean bean,LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
