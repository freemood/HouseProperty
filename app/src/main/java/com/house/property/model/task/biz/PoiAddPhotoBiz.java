...
public class PoiAddPhotoBiz extends BaseBiz {
    /**
     * 新增楼栋详细信息
     */
    private final String API_LOGIN = "file/insertPhotoFiles";

    public void addNewPoiPhoto(List<DimFileinfoVO> bean, LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
...
//        request =getMap(jsonStr);
        ...
        request.put("dimFileinfoVOList", bean);
