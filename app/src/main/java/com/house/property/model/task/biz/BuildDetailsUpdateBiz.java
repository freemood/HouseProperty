...
public class BuildDetailsUpdateBiz extends BaseBiz {
    /**
     *更新小区楼栋详细信息
     */
    private final String API_LOGIN = "build/updateBuildDetails";
    public void updateBuildDetails(BuildDetailsVO bean, LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
