...
public class TaskDoneMessageListRecyclerViewAdapter extends RecyclerView.Adapter<TaskDoneMessageListRecyclerViewAdapter.ViewHolder> {
    ...
    public TaskDoneMessageListRecyclerViewAdapter(Context context, List<TaskBean> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public TaskDoneMessageListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                                int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(context)
                .inflate(R.layout.listview_task_done_list_item, parent, false);
